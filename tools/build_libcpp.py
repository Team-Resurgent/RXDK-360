...
ABI_FLAGS = COMMON + [
    ...
    "-D_GNU_SOURCE",
    # (The old -D_SC_NPROCESSORS_ONLN=200 override is gone: the consolidated
    # picolibc 'xbox' branch defines _SC_NPROCESSORS_ONLN itself, and
    # runtime/xbox/sysconf.c now answers on picolibc's own value.)
